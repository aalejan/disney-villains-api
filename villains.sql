...
INSERT INTO villains(name, movie, slug) VALUES('Captain Hook', 'Peter Pan', 'captain-hool')
...
CREATE USER 'villain'@'localhost' IDENTIFIED WITH mysql_native_password BY 'myVillain';

GRANT ALL ON disneyCharacters.* TO 'villain'@'localhost';